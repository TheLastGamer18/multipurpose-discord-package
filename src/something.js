...
class Something {
  ...
  async fetchHentaiGif() {
    let json = await fetch("https://nekos.life/api/v2/img/Random_hentai_gif")
    let hentai = await json.json()
  ...
  async fetchLesbianGif() {
    let json = await fetch("https://nekos.life/api/v2/img/les")
  ...
  async fetchBoobsGif() {
    let json = await fetch("https://nekos.life/api/v2/img/boobs")
    let boobs = await json.json()
  ...
  async fetchTits() {
    let json = await fetch("https://nekos.life/api/v2/img/tits")
    let tits = await json.json()
  ...
  async fetchNSFWAvatar() {
    let json = await fetch("https://nekos.life/api/v2/img/nsfw_avatar")
    let avatar = await json.json()
